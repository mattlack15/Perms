...
public class ProxyComm implements PluginMessageListener {
    ...
    public ProxyComm(){
        ...
        Bukkit.getMessenger().registerOutgoingPluginChannel(SpigotPerms.instance, CHANNEL);
        Bukkit.getMessenger().registerIncomingPluginChannel(SpigotPerms.instance, CHANNEL, this);
    }
