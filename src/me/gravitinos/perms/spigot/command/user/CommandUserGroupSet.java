...
public class CommandUserGroupSet extends GravSubCommand {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args, Object... passedArgs) {
        ...
        user.setDisplayGroup(context.getServerName(), group);
        this.sendErrorMessage(sender, SpigotPerms.pluginPrefix + "&e" + group.getName() + " &7was set as &a" + user.getName() + "&7's &conly&7 inheritance");
