...
public class CommandGroupParentsClear extends GravSubCommand {
    public CommandGroupParentsClear(GravCommandPermissionable parentCommand, String cmdPath) {
    ...
    public String getDescription() {
        return "Clears ALL parents from a group, on ALL servers";
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args, Object... passedArgs) {
        ...
        this.sendErrorMessage(sender, SpigotPerms.pluginPrefix + "&e" + group.getName() + "&7's inheritance has been completely cleared on all servers");
